...
#' Available information about species is reduced to presence-absence as species abundances can contain much noise (beeing affected by complex factors) and the results of Logistic Regression are easier to interpret as "probability of species occurence".
#' Response curves are only a simplification of reality and their shape is strongly dependent on the available dataset.
#' @examples
